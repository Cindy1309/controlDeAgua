...
<body>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('casas.updateAdmin', $casa->_id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <input type="text" id="numero_casa" name="numero_casa" class="input-field" value="{{ old('numero_casa', $casa->numero_casa) }}" required>

            <label for="calle">Calle:</label>
            <input type="text" id="calle" name="calle" class="input-field" value="{{ old('calle', $casa->calle) }}" required>
            ...
            <select id="tipo_almacenamiento" name="tipo_almacenamiento" class="input-field" required>
                <option value="Tinaco" {{ old('tipo_almacenamiento', $casa->tipo_almacenamiento) == 'Tinaco' ? 'selected' : '' }}>Tinaco</option>
            </select>

            <label for="propietario">Propietario:</label>
            <input type="text" id="propietario" name="propietario" class="input-field" value="{{ old('propietario', $casa->propietario) }}" required>

            <button type="submit" class="submit-btn">Actualizar Casa</button>
            <a href="{{ route('control.admin') }}" class="cancel-btn">Cancelar</a>
        </form>
    </div>
